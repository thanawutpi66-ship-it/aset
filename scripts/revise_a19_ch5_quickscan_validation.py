...
def main() -> None:
    ...
    p(
        ...
        "ด้านความจุ” ได้จากค่า 3.245–3.355 Ah เพียงอย่างเดียว เพราะแบตเตอรี่พิกัด 5.3 Ah ถูกระบุที่อัตราอ้างอิง C10 "
        "ไม่ใช่ 1C และรอบที่ 1 เริ่ม main discharge ที่ SoC 94.32% ไม่เต็ม 100%"
    )
    p(
        "หากต้องการแปลงค่าประมาณ 3.279 Ah ที่ 1C ให้เทียบเท่า 5.3 Ah ที่ C10 ตามสมการ Peukert "
