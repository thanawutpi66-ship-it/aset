...
class BatteryProfile:
    ...
    discharge_c_rate: float = 0.2           # C-rate for constant-current discharge (× capacity_ah)
...
_FALLBACK = {
    "LiFePO4 25.6V (8S, 50Ah)": BatteryProfile(
        ...
        29.2, 20.0, 25.0, 50.0, 30.0, 18.0, 45.0, 55.0, 0.050),
    "Lead-Acid 12V (6S, 7Ah)": BatteryProfile(
        "Lead-Acid 12V (6S, 7Ah)", "Lead-Acid", 12.0, 6, 7.0,
        14.4, 10.5, 1.4, 7.0, 15.0, 10.0, 45.0, 55.0, 0.050),
}
